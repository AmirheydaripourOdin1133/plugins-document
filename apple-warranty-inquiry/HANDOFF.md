...
> آخرین به‌روزرسانی سند: **2026-05** · نسخهٔ محصول: **1.1.7**
...
- جدول همان ساختار چندستونهٔ قبلی؛ در موبایل اسکرول افقی داخل `.awi-records-table-wrap` (بدون حذف ستون).
...
1. وارد کردن کد امنیتی (تصویر) + شماره سریال (آیکون سطل زباله سمت چپ فیلد برای پاک کردن سریع، مخصوصاً موبایل).
2. دکمه **بررسی شناسه**.
...
```php
// plugin.php — نسخه محصول (همه باید 1.1.7 باشند)
// * Version:           1.1.7   (هدر فایل پلاگین)
// * APPLE_WARRANTY_VERSION
// * readme.txt → Stable tag
APPLE_WARRANTY_VERSION      // '1.1.7' — cache-bust دارایی‌های CSS/JS
...
| 1.1.5 | ریسپانسیو جدول سریال‌ها در ادمین؛ دکمه × پاک کردن سریال در فرانت |
| 1.1.6 | بازگردانی ستون‌های جدول ادمین؛ اسکرول افقی موبایل؛ آیکون سطل زباله در فرانت |
| 1.1.7 | هم‌گام‌سازی نسخه برای انتشار نهایی فاز فعلی |
